    ...
    <div className="security-page fade-in">
      <div className="container">
        <div className="security-header text-center">
          ...
          <p className="section-subtitle">Transparency and safety are the foundation of ChainHire.</p>
        </div>
        ...
        <div className="security-grid">
          <section className="glass-panel security-card">
            ...
            <div className="security-actions">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="btn-outline-subtle security-action">View Source on GitHub</a>
            </div>
          </section>
          ...
          <section className="glass-panel security-card">
            ...
            <ul className="security-list">
              ...
              <li><strong>Approval Based:</strong> ETH is released only when the client explicitly approves the delivery.</li>
              <li><strong>Low Fee:</strong> Completed deals release 99% to the freelancer and 1% to the platform.</li>
            </ul>
          </section>
          ...
          <section className="glass-panel security-card">
            ...
            <ul className="security-list">
              ...
              <li>Verify the contract address on Etherscan before signing transactions.</li>
              <li>Use a separate test wallet and keep primary funds in cold storage.</li>
            </ul>
          </section>
          ...
          <section className="glass-panel security-card">
            ...
            <h2>Bug Reporting</h2>
            <p className="text-muted">Found a vulnerability or a bug? Your security research helps us improve the platform.</p>
            <div className="security-actions">
              <a href="mailto:karimhazem05@gmail.com" className="btn-glow security-action">Contact Security Team</a>
              <a href="https://github.com/issues" target="_blank" rel="noopener noreferrer" className="btn-outline-subtle security-action">Open GitHub Issue</a>
            </div>
          </section>
        </div>

        <div className="glass-panel disclaimer-box">
        ...
        <div className="security-back-link">
